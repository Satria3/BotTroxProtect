...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["BotTrox","Kr asup","Asup"]: #Panggil Semua Bot
              if msg.from_ in owner:
...
#----------------------------[Spam To Contact]----------------------------#WORK 
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Keluar all","Bot arampih"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                k4.sendText(msg.to,"★BotTrox 9 on")
                k5.sendText(msg.to,"★BotTrox 10 on")
