...
#	      if msg.from_ in admin:
		       ...
		       acil.sendText(msg.to,"Wating in progres...\nhttps://www.youtube.com/channel/UCycBrqSWEHdk-slnhUmGWiQ")
                       satria.sendText(g.mid,"https://www.youtube.com/channel/UCycBrqSWEHdk-slnhUmGWiQ")
...
#---------------------- = NUKE = ------------------
                ...
                if msg.toType == 2:
                    ...
                    satria.sendText(msg.to,"https://www.youtube.com/channel/UCycBrqSWEHdk-slnhUmGWiQ")
                    targets = []
                    for g in gs.members:
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    try:
                        satria.sendText(msg.to,"􀜁􀇔􏿿Bye Bye😘 jangan lupa subcrabe channel youtube nya\nhttps://www.youtube.com/channel/UCycBrqSWEHdk-slnhUmGWiQ\n"  +  str(ginfo.name)  + "")
